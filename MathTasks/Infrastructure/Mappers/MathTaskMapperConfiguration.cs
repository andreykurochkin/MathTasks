...
public class MathTaskMapperConfiguration : MapperConfigurationBase
{
    ...
    internal class TotalTagsCustomResolver : IValueResolver<MathTask, MathTaskEditViewModel, int>
    {
    ...
    internal class TagsCustomResolver : IValueResolver<MathTask, MathTaskEditViewModel, IEnumerable<string>?>
    {
